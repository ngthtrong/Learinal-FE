    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-large p-8 max-w-lg w-full text-center">
            <div className="text-6xl mb-4">⚠️</div>
            <h1 className="text-2xl font-bold text-gray-900 mb-3">Oops! Có lỗi xảy ra</h1>
            ...
            {import.meta.env.DEV && this.state.error && (
              <details className="text-left mb-6 bg-gray-50 rounded-lg p-4">
                ...
                <pre className="mt-3 text-xs text-red-600 overflow-auto max-h-48 p-3 bg-white rounded border border-red-200">
