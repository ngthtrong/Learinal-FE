/**
 * Expert Create Question Set Manually
 * Expert tạo bộ đề thủ công từng câu hỏi
 */
    ...
    try {
      const payload = {
        ...
        questions: questions.map(q => {
          // Filter empty options và điều chỉnh correctAnswerIndex
...
export default ExpertCreateManualPage;
