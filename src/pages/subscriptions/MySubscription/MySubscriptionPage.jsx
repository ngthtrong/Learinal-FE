    ...
    return (
      <div className="my-subscription-page">
        <div className="no-subscription">
          ...
          <p>
            Gói đăng ký của bạn hiện đang ở trạng thái: <strong>{getStatusText(subscription.status)}</strong>
          </p>
          ...
          {subscription.status === "Cancelled" && (
            <p>Gói đăng ký của bạn đã bị hủy.</p>
          )}
          <Button onClick={() => navigate("/subscriptions/plans")}>
            Xem các gói đăng ký
          </Button>
              ...
              {Object.entries(subscription.entitlementsSnapshot).map(([key, value]) => (
                <div key={key} className="entitlement-item">
                  ...
                  <div className="entitlement-content">
                    ...
                    <span className="entitlement-value">
