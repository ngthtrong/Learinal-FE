        ...
        {sortedPlans.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 sm:py-16 px-4 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="relative w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 mb-4 sm:mb-6">
              <div className="absolute inset-0 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-600 dark:to-gray-700 rounded-2xl sm:rounded-3xl"></div>
              <div className="absolute inset-1.5 sm:inset-2 bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl flex items-center justify-center">
            ...
            {sortedPlans.map((plan) => {
              ...
              return (
                <div
                  ...
                  className={`group relative overflow-hidden rounded-xl sm:rounded-2xl bg-white dark:bg-gray-800 border-2 shadow-sm hover:shadow-lg transition-all duration-300 ${
                  ...
                  <div className="relative p-4 sm:p-6 lg:p-8">
                    <div className="text-center mb-4 sm:mb-6">
                      ...
                      <div className="flex items-baseline justify-center gap-0.5 sm:gap-1">
                        <span className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-primary-600 dark:text-primary-400">
